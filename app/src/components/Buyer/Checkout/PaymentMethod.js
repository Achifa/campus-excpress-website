        ...
        <>
            <div className="buyer-checkout-payment-method">
                ...
                <div className="input-cnt">
                    ...
                    <label style={{color: '#000', fontSize: 'medium'}} htmlFor="ceWallet"><small>Pay With Campus Wallet</small></label>
                </div>

                <div className="input-cnt">
                    <input defaultChecked type="radio" onInput={e => set_up_payment_source('bank')} name="paymentMethod" id="Card" />
                    <label style={{color: '#000', fontSize: 'medium'}} htmlFor="Card"><small>Pay With Card, Bank Transfer, USSD</small></label>
