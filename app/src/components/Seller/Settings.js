    ...
    return ( 
        <>
            <div className="seller-settings">
                {
                    [{text: 'Password/Security', link: 'password-reset'}, {text: 'Identity/Verification', link: 'verification'}, {text: 'Notification Setup', link: 'notification-setup'}, {text: 'Profile Settings', link: 'profile-setup'}].map(item =>  
