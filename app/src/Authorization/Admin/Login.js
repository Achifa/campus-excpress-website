...
import { LogAdminIn } from "../../api/admin";
const SellerLogin = () => {
    ...
    let Login = (e) => {
        ...
        if(validation.current){
            ...
            LogAdminIn(email,pwd)
            .then((result) => {
                window.localStorage.setItem("CE_admin_id", result.id)
                window.localStorage.setItem("CE_admin_name_initial", result.name)
                navigate('/admin')
            })
            .catch((err) => {
                console.log(err)
        ...
        <>
            <div className="seller-login-cnt">
                ...
                <section className="shadow-sm">
                    ...
                    <div onClick={e => navigate('/admin/signup')}>
